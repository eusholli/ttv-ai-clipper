...
A full-stack application with a React frontend and Python FastAPI backend for processing and searching YouTube clips. Features include user authentication, clip transcription search, and cloud storage integration.
